  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end justify-center">
      <div className="w-full max-w-[480px] bg-[#0a0a0f] border-t-4 border-white shadow-[0_-4px_0_#000] p-6 pb-8 max-h-[80vh] overflow-y-auto">
        {/* Header */}
        <div className="font-pixel text-[12px] text-white mb-4">EQUIP ITEM</div>
        ...
        {/* Team list */}
        <div className="font-pixel text-[10px] text-[#94a3b8] mb-3">EQUIP TO:</div>
        <div className="flex flex-col gap-3 mb-6">
          {team.map((pokemon, idx) => (
            <div key={idx} className="flex items-center gap-3">
              ...
              {pokemon.heldItem && (
                <div className="font-terminal text-[16px] text-[#94a3b8] whitespace-nowrap">
          ...
          {team.length === 0 && (
            <div className="font-terminal text-[18px] text-[#94a3b8]">No Pokemon in team.</div>
          )}
        </div>
